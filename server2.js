...
const openapiPath = path.join(__dirname, 'openapi2.yaml');
...
app.use('/docs', swaggerUi.serve, swaggerUi.setup(null, { swaggerUrl: '/openapi2.yaml' }));
app.get('/openapi2.yaml', (_, res) => res.type('text/yaml').send(openapiDoc));
